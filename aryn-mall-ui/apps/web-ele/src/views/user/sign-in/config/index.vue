  ...
  <div class="hx-layout-container">
    <div class="hx-layout-container-auto hx-layout-container-view">
      <div class="hx-table-toolbar">
        <div><ElButton type="primary" v-access:code="'user:signinconfig:add'" @click="handleAdd" :icon="Plus">新增</ElButton></div>
      ...
      <ElTable v-loading="loading" :data="state.tableData" border>
        ...
        <ElTableColumn label="操作" width="150" align="center">
          <template #default="scope">
            <ElButton link type="primary" v-access:code="'user:signinconfig:edit'" @click="handleEdit(scope.row)" :icon="Edit">编辑</ElButton>
            <ElButton link type="danger" v-access:code="'user:signinconfig:del'" @click="handleDelete(scope.row)" :icon="Delete">删除</ElButton>
          </template>
        </ElTableColumn>
      </ElTable>
