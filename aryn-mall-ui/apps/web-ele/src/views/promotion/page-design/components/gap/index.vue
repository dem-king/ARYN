...
const getGapStyle = computed(() => {
  return {
    ...
    background: `linear-gradient(${props.showData.gapBgColorDirection || 'to right'},
				${props.showData.gapBgStartColor || ''},
				${props.showData.gapBgEndColor || props.showData.gapBgStartColor || ''})`,
  };
});
...
<template>
  <div :style="dynamicStyles">
    <div class="gap" :style="getGapStyle"></div>
  </div>
</template>
