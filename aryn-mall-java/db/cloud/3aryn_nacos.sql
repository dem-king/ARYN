...
-- 站内信与客服会话服务配置
INSERT INTO `config_info` VALUES (14, 'aryn-message-biz-dev.yml', 'DEFAULT_GROUP', 'spring:\n  datasource:\n    type: com.alibaba.druid.pool.DruidDataSource\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    username: root\n    password: 123456\n    url: jdbc:mysql://aryn-mysql:3306/aryn_message?useUnicode=true&characterEncoding=utf8mb4&serverTimezone=Asia/Shanghai&useSSL=false&allowPublicKeyRetrieval=true&rewriteBatchedStatements=true&cachePrepStmts=true&useServerPrepStmts=true\n\nlogging:\n  level:\n    com.aryn.cloud.message.mapper: debug\n\nhx:\n  tenant:\n    tables:\n      - message_notice\n      - message_recipient\n      - message_dispatch_task\n      - message_conversation\n      - message_participant\n      - message_chat\n      - message_agent\n      - message_assignment_log\n', 'f19cbf10770c1574dc7ffa1405dad84f', '2026-07-21 22:30:00', '2026-07-21 22:30:00', 'nacos', '127.0.0.1', '', 'public', '', NULL, NULL, 'yaml', NULL, '');
