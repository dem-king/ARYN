...
const sections = [
  ...
  ['租户业务模式能力启用', '68tenant_business_mode_incremental.sql'],
  ['首页船舶工作台装修化', '69ship_workbench_component_incremental.sql'],
  ['商超商品主图回填', '70grocery_product_images.sql'],
  ['商超类目图片回填', '71grocery_category_images.sql'],
  ['船舶物料类目图片回填', '72vessel_category_images.sql'],
