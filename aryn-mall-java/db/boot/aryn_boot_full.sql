-- 悦航购 Aetheryn Mall - Boot 模式全量数据库初始化
...
-- ============================================================================
-- 创建数据库
-- Source: db/boot/1schema.sql
-- ============================================================================
-- 核心库
CREATE DATABASE IF NOT EXISTS `aryn_boot` default character set utf8mb4 collate utf8mb4_general_ci;

-- 定时任务相关库
CREATE DATABASE IF NOT EXISTS `aryn_boot_job` default character set utf8mb4 collate utf8mb4_general_ci;

-- ============================================================================
-- Boot 商城基础库
-- Source: db/boot/2aryn_boot.sql
-- ============================================================================
...
-- ============================================================================
-- 商品品牌
-- Source: db/boot/19product_brand.sql
-- ============================================================================
USE aryn_boot;
...
-- ============================================================================
-- 商超品类与商品种子数据
-- Source: db/boot/41grocery_catalog_seed.sql
-- ============================================================================
-- 悦航购商超品类与商品种子数据
-- 参考：小象超市/盒马鲜生等前置仓商超的品类组织方式（蔬菜/水果/肉禽蛋/海鲜水产/乳品烘焙/熟食预制菜等）
-- 内容：12 个一级类目、51 个二级类目、42 个品牌、106 个在售商品及默认 SKU，全部挂主租户 1590229800633634816
-- 特性：可重复执行；仅按 95x 人工编排前缀清理本脚本自身的种子数据，不触碰存量业务数据
-- 说明：商品图 spu_urls / category_pic 暂留空，请运营在管理后台上传图片后回填
-- 执行：mysql -u root -p aryn_boot < 41grocery_catalog_seed.sql（Boot 单体模式，目标库 aryn_boot）
...
-- ---------- 清理本脚本历史种子（幂等） ----------
DELETE FROM `goods_sku` WHERE `id` LIKE '955%';
DELETE FROM `goods_spu` WHERE `id` LIKE '954%';
DELETE FROM `goods_category` WHERE `id` LIKE '951%' OR `id` LIKE '952%';
DELETE FROM `goods_brand` WHERE `id` LIKE '953%';

-- ---------- 商超类目（12 个一级 / 51 个二级） ----------
INSERT INTO `goods_category` (`id`, `name`, `parent_id`, `category_pic`, `description`, `status`, `create_time`, `update_time`, `del_flag`, `sort`, `tenant_id`, `create_by`, `update_by`) VALUES
('9510000000000000001', '蔬菜', '0', NULL, '新鲜蔬菜，每日产地直采，30分钟新鲜到家', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000001', '叶菜类', '9510000000000000001', NULL, '蔬菜·叶菜类，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000002', '根茎类', '9510000000000000001', NULL, '蔬菜·根茎类，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000003', '茄果瓜类', '9510000000000000001', NULL, '蔬菜·茄果瓜类，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000004', '葱蒜椒', '9510000000000000001', NULL, '蔬菜·葱蒜椒，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9520000000000000005', '食用菌菇', '9510000000000000001', NULL, '蔬菜·食用菌菇，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 5, '1590229800633634816', 'system', NULL),
('9520000000000000006', '豆制品', '9510000000000000001', NULL, '蔬菜·豆制品，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 6, '1590229800633634816', 'system', NULL),
('9510000000000000002', '水果', '0', NULL, '时令鲜果，产地直采冷链直达', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000007', '苹果梨', '9510000000000000002', NULL, '水果·苹果梨，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000008', '柑橘橙柚', '9510000000000000002', NULL, '水果·柑橘橙柚，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000009', '热带水果', '9510000000000000002', NULL, '水果·热带水果，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000010', '瓜类', '9510000000000000002', NULL, '水果·瓜类，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9520000000000000011', '浆果葡萄', '9510000000000000002', NULL, '水果·浆果葡萄，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 5, '1590229800633634816', 'system', NULL),
('9510000000000000003', '肉禽蛋', '0', NULL, '冷鲜肉禽蛋，当日质检 冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000012', '猪肉', '9510000000000000003', NULL, '肉禽蛋·猪肉，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000013', '牛肉', '9510000000000000003', NULL, '肉禽蛋·牛肉，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000014', '羊肉', '9510000000000000003', NULL, '肉禽蛋·羊肉，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000015', '禽肉', '9510000000000000003', NULL, '肉禽蛋·禽肉，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9520000000000000016', '蛋类', '9510000000000000003', NULL, '肉禽蛋·蛋类，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 5, '1590229800633634816', 'system', NULL),
('9510000000000000004', '海鲜水产', '0', NULL, '鲜活水产，现捞现发 冰鲜直达', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9520000000000000017', '活鲜', '9510000000000000004', NULL, '海鲜水产·活鲜，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000018', '冰鲜鱼', '9510000000000000004', NULL, '海鲜水产·冰鲜鱼，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000019', '虾蟹贝', '9510000000000000004', NULL, '海鲜水产·虾蟹贝，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000020', '冷冻水产', '9510000000000000004', NULL, '海鲜水产·冷冻水产，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9510000000000000005', '乳品烘焙', '0', NULL, '日日鲜系列，只卖当日 不隔夜', '0', NULL, NULL, '0', 5, '1590229800633634816', 'system', NULL),
('9520000000000000021', '鲜奶', '9510000000000000005', NULL, '乳品烘焙·鲜奶，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000022', '酸奶', '9510000000000000005', NULL, '乳品烘焙·酸奶，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000023', '常温乳品', '9510000000000000005', NULL, '乳品烘焙·常温乳品，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000024', '面包烘焙', '9510000000000000005', NULL, '乳品烘焙·面包烘焙，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9510000000000000006', '熟食预制菜', '0', NULL, '3R好物，即烹即热即食', '0', NULL, NULL, '0', 6, '1590229800633634816', 'system', NULL),
('9520000000000000025', '快手菜', '9510000000000000006', NULL, '熟食预制菜·快手菜，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000026', '预制菜肴', '9510000000000000006', NULL, '熟食预制菜·预制菜肴，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000027', '卤味熟食', '9510000000000000006', NULL, '熟食预制菜·卤味熟食，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000028', '面点主食', '9510000000000000006', NULL, '熟食预制菜·面点主食，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9510000000000000007', '米面粮油', '0', NULL, '基础口粮，大牌直供 稳定供应', '0', NULL, NULL, '0', 7, '1590229800633634816', 'system', NULL),
('9520000000000000029', '大米面粉', '9510000000000000007', NULL, '米面粮油·大米面粉，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000030', '杂粮', '9510000000000000007', NULL, '米面粮油·杂粮，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000031', '食用油', '9510000000000000007', NULL, '米面粮油·食用油，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000032', '调味品', '9510000000000000007', NULL, '米面粮油·调味品，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9510000000000000008', '休闲零食', '0', NULL, '解馋零食，追剧聚会常备', '0', NULL, NULL, '0', 8, '1590229800633634816', 'system', NULL),
('9520000000000000033', '坚果炒货', '9510000000000000008', NULL, '休闲零食·坚果炒货，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000034', '膨化食品', '9510000000000000008', NULL, '休闲零食·膨化食品，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000035', '饼干糕点', '9510000000000000008', NULL, '休闲零食·饼干糕点，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000036', '糖果巧克力', '9510000000000000008', NULL, '休闲零食·糖果巧克力，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9520000000000000037', '果干蜜饯', '9510000000000000008', NULL, '休闲零食·果干蜜饯，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 5, '1590229800633634816', 'system', NULL),
('9510000000000000009', '酒水饮料', '0', NULL, '冰爽饮品，冷藏出库 送达即饮', '0', NULL, NULL, '0', 9, '1590229800633634816', 'system', NULL),
('9520000000000000038', '饮用水', '9510000000000000009', NULL, '酒水饮料·饮用水，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000039', '碳酸饮料', '9510000000000000009', NULL, '酒水饮料·碳酸饮料，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000040', '果汁茶饮', '9510000000000000009', NULL, '酒水饮料·果汁茶饮，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000041', '啤酒', '9510000000000000009', NULL, '酒水饮料·啤酒，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9520000000000000042', '白酒红酒', '9510000000000000009', NULL, '酒水饮料·白酒红酒，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 5, '1590229800633634816', 'system', NULL),
('9510000000000000010', '个护清洁', '0', NULL, '个护家清，大牌正品 一步到家', '0', NULL, NULL, '0', 10, '1590229800633634816', 'system', NULL),
('9520000000000000043', '洗发沐浴', '9510000000000000010', NULL, '个护清洁·洗发沐浴，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000044', '口腔护理', '9510000000000000010', NULL, '个护清洁·口腔护理，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000045', '纸品湿巾', '9510000000000000010', NULL, '个护清洁·纸品湿巾，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9520000000000000046', '家庭清洁', '9510000000000000010', NULL, '个护清洁·家庭清洁，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 4, '1590229800633634816', 'system', NULL),
('9510000000000000011', '日用百货', '0', NULL, '居家好物，一站式购齐', '0', NULL, NULL, '0', 11, '1590229800633634816', 'system', NULL),
('9520000000000000047', '厨房用品', '9510000000000000011', NULL, '日用百货·厨房用品，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000048', '家居收纳', '9510000000000000011', NULL, '日用百货·家居收纳，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL),
('9520000000000000049', '一次性用品', '9510000000000000011', NULL, '日用百货·一次性用品，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 3, '1590229800633634816', 'system', NULL),
('9510000000000000012', '鲜花绿植', '0', NULL, '云南直采，基地直发 冷链保鲜', '0', NULL, NULL, '0', 12, '1590229800633634816', 'system', NULL),
('9520000000000000050', '鲜切花', '9510000000000000012', NULL, '鲜花绿植·鲜切花，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 1, '1590229800633634816', 'system', NULL),
('9520000000000000051', '绿植多肉', '9510000000000000012', NULL, '鲜花绿植·绿植多肉，精选当季优质商品，每日冷链直配', '0', NULL, NULL, '0', 2, '1590229800633634816', 'system', NULL);

-- ---------- 品牌（42 个：悦航自有品牌 4 个 + 热销三方品牌） ----------
INSERT INTO `goods_brand` (`id`, `name`, `logo_url`, `description`, `status`, `sort`, `tenant_id`, `create_by`, `update_by`, `create_time`, `update_time`, `del_flag`) VALUES
('9530000000000000001', '悦航优选', NULL, '悦航购自有品牌，精选全球原产地基础好物', '0', 1, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000002', '悦航优鲜', NULL, '悦航购自有鲜奶品牌，只卖当日 不隔夜', '0', 2, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000003', '悦航工坊', NULL, '悦航购自有烘焙熟食品牌，现烤现做', '0', 3, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000004', '悦航大厨', NULL, '悦航购自有预制菜品牌，洗切配齐 快手出餐', '0', 4, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000005', '温氏', NULL, '温氏食品，放心禽肉供应商', '0', 5, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000006', '正大', NULL, '正大集团，安全可追溯的蛋品专家', '0', 6, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000007', '简爱', NULL, '简爱酸奶，生牛乳发酵 0添加', '0', 7, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000008', '蒙牛', NULL, '蒙牛乳业，营养你的要强', '0', 8, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000009', '伊利', NULL, '伊利乳业，滋养生命活力', '0', 9, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000010', '特仑苏', NULL, '蒙牛旗下高端牛奶品牌', '0', 10, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000011', '金龙鱼', NULL, '益海嘉里旗下粮油品牌', '0', 11, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000012', '香满园', NULL, '益海嘉里旗下面点专用粉品牌', '0', 12, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000013', '鲁花', NULL, '鲁花集团，中国花生油专家', '0', 13, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000014', '海天', NULL, '海天味业，中华老字号调味品品牌', '0', 14, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000015', '太太乐', NULL, '上海太太乐，鲜味调味品专家', '0', 15, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000016', '洽洽', NULL, '洽洽食品，坚果炒货领导品牌', '0', 16, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000017', '三只松鼠', NULL, '三只松鼠，互联网坚果零食品牌', '0', 17, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000018', '乐事', NULL, '百事旗下薯片品牌', '0', 18, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000019', '好丽友', NULL, '好丽友食品，松软香甜好滋味', '0', 19, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000020', '奥利奥', NULL, '亿滋旗下经典夹心饼干品牌', '0', 20, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000021', '盼盼', NULL, '盼盼食品，国民烘焙品牌', '0', 21, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000022', '德芙', NULL, '玛氏旗下巧克力品牌，纵享丝滑', '0', 22, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000023', '徐福记', NULL, '徐福记，新年糖与休闲糖点品牌', '0', 23, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000024', '百草味', NULL, '百草味，全品类休闲零食品牌', '0', 24, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000025', '农夫山泉', NULL, '农夫山泉，大自然的搬运工', '0', 25, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000026', '可口可乐', NULL, '可口可乐公司，全球知名饮料品牌', '0', 26, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000027', '元气森林', NULL, '元气森林，0糖0脂0卡气泡水', '0', 27, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000028', '三得利', NULL, '三得利，无糖茶饮开创者', '0', 28, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000029', '青岛啤酒', NULL, '青岛啤酒，百年中国啤酒品牌', '0', 29, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000030', '百威', NULL, '百威啤酒，世界知名啤酒品牌', '0', 30, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000031', '牛栏山', NULL, '牛栏山酒厂，二锅头宗师', '0', 31, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000032', '张裕', NULL, '张裕葡萄酒，中国葡萄酒领跑者', '0', 32, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000033', '海飞丝', NULL, '宝洁旗下去屑洗发品牌', '0', 33, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000034', '舒肤佳', NULL, '宝洁旗下除菌洗护品牌', '0', 34, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000035', '云南白药', NULL, '云南白药，国民口腔护理品牌', '0', 35, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000036', '高露洁', NULL, '高露洁，全球口腔护理专家', '0', 36, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000037', '维达', NULL, '维达，纸巾湿巾领导品牌', '0', 37, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000038', '心相印', NULL, '心相印，恒安集团生活用纸品牌', '0', 38, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000039', '蓝月亮', NULL, '蓝月亮，专业家庭清洁品牌', '0', 39, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000040', '立白', NULL, '立白，国民洗护清洁品牌', '0', 40, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000041', '美丽雅', NULL, '美丽雅，家居清洁用品品牌', '0', 41, '1590229800633634816', 'system', NULL, NULL, NULL, '0'),
('9530000000000000042', '妙洁', NULL, '妙洁，一次性用品与保鲜专家', '0', 42, '1590229800633634816', 'system', NULL, NULL, NULL, '0');

-- ---------- 商品（106 个在售 SPU + 默认 SKU，全部包邮） ----------
-- 蔬菜
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000001', '油麦菜 约300g/份', '当日现采 嫩绿清脆', '', '1', 470, '9510000000000000001', '9520000000000000001', NULL, '2026-09-01 09:03:00', NULL, '0', '<p>【商品名称】油麦菜 约300g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 380, '0', NULL, 3.90, 4.90, 2.54),
('9540000000000000002', '新鲜菠菜 约300g/份', '叶片肥厚 爽口微甜', '', '1', 607, '9510000000000000001', '9520000000000000001', NULL, '2026-09-01 09:06:00', NULL, '0', '<p>【商品名称】新鲜菠菜 约300g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 477, '0', NULL, 4.90, 5.90, 3.19),
('9540000000000000003', '娃娃菜 3颗装 约500g', '黄心嫩甜 火锅必备', '', '1', 744, '9510000000000000001', '9520000000000000001', NULL, '2026-09-01 09:09:00', NULL, '0', '<p>【商品名称】娃娃菜 3颗装 约500g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 574, '0', NULL, 6.90, 8.90, 4.49),
('9540000000000000004', '黄心土豆 约500g/份', '粉糯香甜 炖炒皆宜', '', '1', 881, '9510000000000000001', '9520000000000000002', NULL, '2026-09-01 09:12:00', NULL, '0', '<p>【商品名称】黄心土豆 约500g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 671, '0', NULL, 3.90, 4.90, 2.54),
('9540000000000000005', '紫皮洋葱 约500g/份', '辛辣味浓 提鲜必备', '', '1', 1018, '9510000000000000001', '9520000000000000002', NULL, '2026-09-01 09:15:00', NULL, '0', '<p>【商品名称】紫皮洋葱 约500g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 768, '0', NULL, 4.50, 5.90, 2.93),
('9540000000000000006', '新鲜胡萝卜 约400g/份', '脆嫩多汁 营养丰富', '', '1', 1155, '9510000000000000001', '9520000000000000002', NULL, '2026-09-01 09:18:00', NULL, '0', '<p>【商品名称】新鲜胡萝卜 约400g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 865, '0', NULL, 3.60, 3.90, 2.34),
('9540000000000000007', '普罗旺斯西红柿 约500g/份', '沙瓤多汁 生吃更佳', '', '1', 1292, '9510000000000000001', '9520000000000000003', NULL, '2026-09-01 09:21:00', NULL, '0', '<p>【商品名称】普罗旺斯西红柿 约500g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 62, '0', NULL, 7.90, 9.90, 5.14),
('9540000000000000008', '荷兰黄瓜 2根装 约300g', '无刺薄皮 清爽脆嫩', '', '1', 1429, '9510000000000000001', '9520000000000000003', NULL, '2026-09-01 09:24:00', NULL, '0', '<p>【商品名称】荷兰黄瓜 2根装 约300g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 159, '0', NULL, 5.90, 6.90, 3.84),
('9540000000000000009', '紫长茄子 约400g/份', '肉质细嫩 少籽味甜', '', '1', 1566, '9510000000000000001', '9520000000000000003', NULL, '2026-09-01 09:27:00', NULL, '0', '<p>【商品名称】紫长茄子 约400g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 256, '0', NULL, 4.50, 5.90, 2.93),
('9540000000000000010', '小香葱 约100g/份', '香气浓郁 现采现发', '', '1', 1703, '9510000000000000001', '9520000000000000004', NULL, '2026-09-01 09:30:00', NULL, '0', '<p>【商品名称】小香葱 约100g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 353, '0', NULL, 2.90, 3.90, 1.89),
('9540000000000000011', '独头蒜 约200g/份', '蒜香浓烈 一头一颗', '', '1', 1840, '9510000000000000001', '9520000000000000004', NULL, '2026-09-01 09:33:00', NULL, '0', '<p>【商品名称】独头蒜 约200g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 450, '0', NULL, 6.90, 8.90, 4.49),
('9540000000000000012', '白玉菇 2连包 约400g', '菇体洁白 口感滑嫩', '', '1', 1977, '9510000000000000001', '9520000000000000005', NULL, '2026-09-01 09:36:00', NULL, '0', '<p>【商品名称】白玉菇 2连包 约400g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 547, '0', NULL, 8.90, 10.90, 5.79),
('9540000000000000013', '新鲜香菇 约300g/份', '肉厚柄短 香味十足', '', '1', 2114, '9510000000000000001', '9520000000000000005', NULL, '2026-09-01 09:39:00', NULL, '0', '<p>【商品名称】新鲜香菇 约300g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 644, '0', NULL, 9.90, 11.90, 6.44),
('9540000000000000014', '嫩豆腐 2盒装 约800g', '豆香浓郁 细嫩爽滑', '', '1', 2251, '9510000000000000001', '9520000000000000006', '9530000000000000001', '2026-09-01 09:42:00', NULL, '0', '<p>【商品名称】嫩豆腐 2盒装 约800g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 741, '0', NULL, 6.50, 7.90, 4.23),
('9540000000000000015', '千张豆腐皮 约300g/份', '薄韧豆香 炒拌皆宜', '', '1', 2388, '9510000000000000001', '9520000000000000006', '9530000000000000001', '2026-09-01 09:45:00', NULL, '0', '<p>【商品名称】千张豆腐皮 约300g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 838, '0', NULL, 5.90, 6.90, 3.84);

-- 水果
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000016', '烟台红富士苹果 4个装 约1kg', '脆甜多汁 当季现摘', '', '1', 2525, '9510000000000000002', '9520000000000000007', NULL, '2026-09-01 09:48:00', NULL, '0', '<p>【商品名称】烟台红富士苹果 4个装 约1kg</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 935, '0', NULL, 15.90, 19.90, 10.34),
('9540000000000000017', '新疆库尔勒香梨 6个装 约1.2kg', '皮薄核小 汁多味甜', '', '1', 2662, '9510000000000000002', '9520000000000000007', NULL, '2026-09-01 09:51:00', NULL, '0', '<p>【商品名称】新疆库尔勒香梨 6个装 约1.2kg</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 132, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000018', '赣南脐橙 5个装 约1kg', '酸甜适口 果香浓郁', '', '1', 2799, '9510000000000000002', '9520000000000000008', NULL, '2026-09-01 09:54:00', NULL, '0', '<p>【商品名称】赣南脐橙 5个装 约1kg</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 229, '0', NULL, 16.90, 20.90, 10.98),
('9540000000000000019', '福建琯溪蜜柚 1个 约1kg', '粒粒饱满 清甜微酸', '', '1', 2936, '9510000000000000002', '9520000000000000008', NULL, '2026-09-01 09:57:00', NULL, '0', '<p>【商品名称】福建琯溪蜜柚 1个 约1kg</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 326, '0', NULL, 12.90, 15.90, 8.38),
('9540000000000000020', '海南高山香蕉 约1kg/把', '自然熟成 软糯香甜', '', '1', 3073, '9510000000000000002', '9520000000000000009', NULL, '2026-09-01 10:00:00', NULL, '0', '<p>【商品名称】海南高山香蕉 约1kg/把</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 423, '0', NULL, 9.90, 11.90, 6.44),
('9540000000000000021', '海南贵妃芒 3个装 约500g', '核薄肉厚 香气扑鼻', '', '1', 3210, '9510000000000000002', '9520000000000000009', NULL, '2026-09-01 10:03:00', NULL, '0', '<p>【商品名称】海南贵妃芒 3个装 约500g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 520, '0', NULL, 13.90, 16.90, 9.04),
('9540000000000000022', '泰国椰青 1个装 约1kg', '椰水清甜 椰肉嫩滑', '', '1', 147, '9510000000000000002', '9520000000000000009', NULL, '2026-09-01 10:06:00', NULL, '0', '<p>【商品名称】泰国椰青 1个装 约1kg</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 617, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000023', '麒麟西瓜 1个 约2kg', '薄皮沙瓤 保熟保甜', '', '1', 284, '9510000000000000002', '9520000000000000010', NULL, '2026-09-01 10:09:00', NULL, '0', '<p>【商品名称】麒麟西瓜 1个 约2kg</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 714, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000024', '西州蜜哈密瓜 1个 约1.5kg', '蜜甜多汁 瓜香四溢', '', '1', 421, '9510000000000000002', '9520000000000000010', NULL, '2026-09-01 10:12:00', NULL, '0', '<p>【商品名称】西州蜜哈密瓜 1个 约1.5kg</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 811, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000025', '云南阳光玫瑰葡萄 500g/串', '玫瑰清香 无籽脆甜', '', '1', 558, '9510000000000000002', '9520000000000000011', NULL, '2026-09-01 10:15:00', NULL, '0', '<p>【商品名称】云南阳光玫瑰葡萄 500g/串</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 908, '0', NULL, 25.90, 31.90, 16.84),
('9540000000000000026', '丹东99红颜草莓 250g/盒', '果香浓郁 香甜软糯', '', '1', 695, '9510000000000000002', '9520000000000000011', NULL, '2026-09-01 10:18:00', NULL, '0', '<p>【商品名称】丹东99红颜草莓 250g/盒</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 105, '0', NULL, 29.90, 36.90, 19.43);

-- 肉禽蛋
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000027', '猪五花肉片 约300g/份', '当日现切 肥瘦相间', '', '1', 832, '9510000000000000003', '9520000000000000012', NULL, '2026-09-01 10:21:00', NULL, '0', '<p>【商品名称】猪五花肉片 约300g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 202, '0', NULL, 15.90, 19.90, 10.34),
('9540000000000000028', '猪里脊肉 约300g/份', '肉质细嫩 健康低脂', '', '1', 969, '9510000000000000003', '9520000000000000012', NULL, '2026-09-01 10:24:00', NULL, '0', '<p>【商品名称】猪里脊肉 约300g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 299, '0', NULL, 17.90, 21.90, 11.63),
('9540000000000000029', '原切谷饲牛腩块 约500g/盒', '原切无添加 炖煮软糯', '', '1', 1106, '9510000000000000003', '9520000000000000013', NULL, '2026-09-01 10:27:00', NULL, '0', '<p>【商品名称】原切谷饲牛腩块 约500g/盒</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 396, '0', NULL, 39.90, 49.90, 25.93),
('9540000000000000030', '澳洲谷饲原切牛排 2片装 约300g', '原切整切 鲜嫩多汁', '', '1', 1243, '9510000000000000003', '9520000000000000013', NULL, '2026-09-01 10:30:00', NULL, '0', '<p>【商品名称】澳洲谷饲原切牛排 2片装 约300g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 493, '0', NULL, 59.90, 74.90, 38.94),
('9540000000000000031', '内蒙古羔羊肉卷 约300g/份', '涮煮不膻 肉质细嫩', '', '1', 1380, '9510000000000000003', '9520000000000000014', NULL, '2026-09-01 10:33:00', NULL, '0', '<p>【商品名称】内蒙古羔羊肉卷 约300g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 590, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000032', '内蒙古羔羊排 约600g/份', '肉层分明 香而不膻', '', '1', 1517, '9510000000000000003', '9520000000000000014', NULL, '2026-09-01 10:36:00', NULL, '0', '<p>【商品名称】内蒙古羔羊排 约600g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 687, '0', NULL, 49.90, 61.90, 32.44),
('9540000000000000033', '温氏三黄鸡 1只 约1kg', '皮薄肉嫩 鲜香味美', '', '1', 1654, '9510000000000000003', '9520000000000000015', '9530000000000000005', '2026-09-01 10:39:00', NULL, '0', '<p>【商品名称】温氏三黄鸡 1只 约1kg</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 784, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000034', '单冻鸡胸肉 约500g/袋', '高蛋白低脂 健身首选', '', '1', 1791, '9510000000000000003', '9520000000000000015', NULL, '2026-09-01 10:42:00', NULL, '0', '<p>【商品名称】单冻鸡胸肉 约500g/袋</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 881, '0', NULL, 12.90, 15.90, 8.38),
('9540000000000000035', '正大鲜鸡蛋 10枚装 约500g', '当日鲜蛋 蛋黄金黄', '', '1', 1928, '9510000000000000003', '9520000000000000016', '9530000000000000006', '2026-09-01 10:45:00', NULL, '0', '<p>【商品名称】正大鲜鸡蛋 10枚装 约500g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 78, '0', NULL, 12.90, 15.90, 8.38),
('9540000000000000036', '红泥咸鸭蛋 6枚装 约360g', '流油起沙 咸香适口', '', '1', 2065, '9510000000000000003', '9520000000000000016', NULL, '2026-09-01 10:48:00', NULL, '0', '<p>【商品名称】红泥咸鸭蛋 6枚装 约360g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 175, '0', NULL, 13.90, 16.90, 9.04);

-- 海鲜水产
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000037', '鲜活河虾 约250g/份', '活虾现捞 肉质Q弹', '', '1', 2202, '9510000000000000004', '9520000000000000017', NULL, '2026-09-01 10:51:00', NULL, '0', '<p>【商品名称】鲜活河虾 约250g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 272, '0', NULL, 39.90, 49.90, 25.93),
('9540000000000000038', '鲜活肉蟹 1只 约400g', '膏满黄肥 鲜活直达', '', '1', 2339, '9510000000000000004', '9520000000000000017', NULL, '2026-09-01 10:54:00', NULL, '0', '<p>【商品名称】鲜活肉蟹 1只 约400g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 369, '0', NULL, 49.90, 61.90, 32.44),
('9540000000000000039', '冰鲜三文鱼刺身段 约200g/盒', '进口原料 当日分切', '', '1', 2476, '9510000000000000004', '9520000000000000018', NULL, '2026-09-01 10:57:00', NULL, '0', '<p>【商品名称】冰鲜三文鱼刺身段 约200g/盒</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 466, '0', NULL, 49.90, 61.90, 32.44),
('9540000000000000040', '冰鲜大黄鱼 1条 约500g', '肉质细嫩 清蒸鲜香', '', '1', 2613, '9510000000000000004', '9520000000000000018', NULL, '2026-09-01 11:00:00', NULL, '0', '<p>【商品名称】冰鲜大黄鱼 1条 约500g</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 563, '0', NULL, 35.90, 44.90, 23.34),
('9540000000000000041', '冷冻白虾仁 约250g/袋', '去线虾仁 弹嫩鲜甜', '', '1', 2750, '9510000000000000004', '9520000000000000019', NULL, '2026-09-01 11:03:00', NULL, '0', '<p>【商品名称】冷冻白虾仁 约250g/袋</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 660, '0', NULL, 24.90, 30.90, 16.18),
('9540000000000000042', '鲜活花蛤 约500g/份', '吐沙干净 鲜味十足', '', '1', 2887, '9510000000000000004', '9520000000000000019', NULL, '2026-09-01 11:06:00', NULL, '0', '<p>【商品名称】鲜活花蛤 约500g/份</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 757, '0', NULL, 12.90, 15.90, 8.38),
('9540000000000000043', '阿根廷红虾 2kg/盒', '船冻锁鲜 个大饱满', '', '1', 3024, '9510000000000000004', '9520000000000000020', NULL, '2026-09-01 11:09:00', NULL, '0', '<p>【商品名称】阿根廷红虾 2kg/盒</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 854, '0', NULL, 79.90, 99.90, 51.94),
('9540000000000000044', '越南巴沙鱼片 约300g/袋', '无刺无腥 嫩滑易煮', '', '1', 3161, '9510000000000000004', '9520000000000000020', NULL, '2026-09-01 11:12:00', NULL, '0', '<p>【商品名称】越南巴沙鱼片 约300g/袋</p><p>【储存方式】冷藏保存，建议尽快食用。</p><p>【温馨提示】生鲜商品因产地与批次不同，规格重量可能略有差异，请以实际收到商品为准；如有质量问题，支持售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 51, '0', NULL, 19.90, 24.90, 12.93);

-- 乳品烘焙
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000045', '悦航优鲜 全脂鲜牛奶 950ml', '只卖当日 巴氏杀菌', '', '1', 98, '9510000000000000005', '9520000000000000021', '9530000000000000002', '2026-09-01 11:15:00', NULL, '0', '<p>【商品名称】悦航优鲜 全脂鲜牛奶 950ml</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 148, '0', NULL, 12.90, 15.90, 8.38),
('9540000000000000046', '悦航优鲜 脱脂鲜牛奶 950ml', '低脂轻盈 营养不减', '', '1', 235, '9510000000000000005', '9520000000000000021', '9530000000000000002', '2026-09-01 11:18:00', NULL, '0', '<p>【商品名称】悦航优鲜 脱脂鲜牛奶 950ml</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 245, '0', NULL, 13.90, 16.90, 9.04),
('9540000000000000047', '简爱 0添加原味酸奶 135g×3杯', '生牛乳发酵 清爽不腻', '', '1', 372, '9510000000000000005', '9520000000000000022', '9530000000000000007', '2026-09-01 11:21:00', NULL, '0', '<p>【商品名称】简爱 0添加原味酸奶 135g×3杯</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 342, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000048', '蒙牛冠益乳 草莓味酸奶 250g×3杯', 'Q弹口感 益生菌发酵', '', '1', 509, '9510000000000000005', '9520000000000000022', '9530000000000000008', '2026-09-01 11:24:00', NULL, '0', '<p>【商品名称】蒙牛冠益乳 草莓味酸奶 250g×3杯</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 439, '0', NULL, 13.90, 16.90, 9.04),
('9540000000000000049', '伊利金典 纯牛奶 250ml×10盒', '3.6g乳蛋白 奶香醇厚', '', '1', 646, '9510000000000000005', '9520000000000000023', '9530000000000000009', '2026-09-01 11:27:00', NULL, '0', '<p>【商品名称】伊利金典 纯牛奶 250ml×10盒</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 536, '0', NULL, 65.90, 81.90, 42.84),
('9540000000000000050', '特仑苏 纯牛奶 250ml×10盒', '3.6g乳蛋白 醇香浓郁', '', '1', 783, '9510000000000000005', '9520000000000000023', '9530000000000000010', '2026-09-01 11:30:00', NULL, '0', '<p>【商品名称】特仑苏 纯牛奶 250ml×10盒</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 633, '0', NULL, 69.90, 86.90, 45.44),
('9540000000000000051', '悦航工坊 爆浆巧克力麻薯 4个装', '现烤出炉 拉丝爆浆', '', '1', 920, '9510000000000000005', '9520000000000000024', '9530000000000000003', '2026-09-01 11:33:00', NULL, '0', '<p>【商品名称】悦航工坊 爆浆巧克力麻薯 4个装</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 730, '0', NULL, 15.90, 19.90, 10.34),
('9540000000000000052', '悦航工坊 全麦贝果 3个装', '低油低糖 有嚼劲', '', '1', 1057, '9510000000000000005', '9520000000000000024', '9530000000000000003', '2026-09-01 11:36:00', NULL, '0', '<p>【商品名称】悦航工坊 全麦贝果 3个装</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 827, '0', NULL, 19.90, 24.90, 12.93);

-- 熟食预制菜
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000053', '悦航大厨 鱼香肉丝快手菜 约350g', '洗切配齐 10分钟出锅', '', '1', 1194, '9510000000000000006', '9520000000000000025', '9530000000000000004', '2026-09-01 11:39:00', NULL, '0', '<p>【商品名称】悦航大厨 鱼香肉丝快手菜 约350g</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 924, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000054', '悦航大厨 宫保鸡丁快手菜 约350g', '主料配料一盒搞定', '', '1', 1331, '9510000000000000006', '9520000000000000025', '9530000000000000004', '2026-09-01 11:42:00', NULL, '0', '<p>【商品名称】悦航大厨 宫保鸡丁快手菜 约350g</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 121, '0', NULL, 21.90, 26.90, 14.23),
('9540000000000000055', '悦航大厨 黑椒牛柳意面 约320g', '酱香浓郁 复热即食', '', '1', 1468, '9510000000000000006', '9520000000000000026', '9530000000000000004', '2026-09-01 11:45:00', NULL, '0', '<p>【商品名称】悦航大厨 黑椒牛柳意面 约320g</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 218, '0', NULL, 25.90, 31.90, 16.84),
('9540000000000000056', '悦航大厨 广式豉汁排骨 约400g', '锡纸盒装 蒸熟即食', '', '1', 1605, '9510000000000000006', '9520000000000000026', '9530000000000000004', '2026-09-01 11:48:00', NULL, '0', '<p>【商品名称】悦航大厨 广式豉汁排骨 约400g</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 315, '0', NULL, 32.90, 40.90, 21.39),
('9540000000000000057', '悦航工坊 五香酱牛肉 约200g/盒', '牛腱原切 切片即食', '', '1', 1742, '9510000000000000006', '9520000000000000027', '9530000000000000003', '2026-09-01 11:51:00', NULL, '0', '<p>【商品名称】悦航工坊 五香酱牛肉 约200g/盒</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 412, '0', NULL, 35.90, 44.90, 23.34),
('9540000000000000058', '悦航工坊 盐水鸭 半只 约600g', '皮白肉嫩 咸鲜清香', '', '1', 1879, '9510000000000000006', '9520000000000000027', '9530000000000000003', '2026-09-01 11:54:00', NULL, '0', '<p>【商品名称】悦航工坊 盐水鸭 半只 约600g</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 509, '0', NULL, 36.90, 45.90, 23.98),
('9540000000000000059', '悦航工坊 鲜虾云吞 20只装 约400g', '整只虾仁 皮薄馅足', '', '1', 2016, '9510000000000000006', '9520000000000000028', '9530000000000000003', '2026-09-01 11:57:00', NULL, '0', '<p>【商品名称】悦航工坊 鲜虾云吞 20只装 约400g</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 606, '0', NULL, 26.90, 33.90, 17.48),
('9540000000000000060', '悦航工坊 老面馒头 6个装 约480g', '老面发酵 麦香松软', '', '1', 2153, '9510000000000000006', '9520000000000000028', '9530000000000000003', '2026-09-01 12:00:00', NULL, '0', '<p>【商品名称】悦航工坊 老面馒头 6个装 约480g</p><p>【储存方式】请按包装标注温度冷藏保存，开封后请尽快食用。</p><p>【温馨提示】本商品经全程冷链配送，如有胀袋、渗漏等异常请勿食用，可联系售后处理。</p>', '0', '1590229800633634816', 'system', NULL, 703, '0', NULL, 9.90, 11.90, 6.44);

-- 米面粮油
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000061', '金龙鱼 东北大米 5kg/袋', '颗粒饱满 米香四溢', '', '1', 2290, '9510000000000000007', '9520000000000000029', '9530000000000000011', '2026-09-01 12:03:00', NULL, '0', '<p>【商品名称】金龙鱼 东北大米 5kg/袋</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 800, '0', NULL, 49.90, 61.90, 32.44),
('9540000000000000062', '香满园 麦芯小麦粉 2.5kg/袋', '粉质细腻 拉伸性好', '', '1', 2427, '9510000000000000007', '9520000000000000029', '9530000000000000012', '2026-09-01 12:06:00', NULL, '0', '<p>【商品名称】香满园 麦芯小麦粉 2.5kg/袋</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 897, '0', NULL, 25.90, 31.90, 16.84),
('9540000000000000063', '悦航优选 有机黄小米 1kg/袋', '米油丰厚 熬粥首选', '', '1', 2564, '9510000000000000007', '9520000000000000030', '9530000000000000001', '2026-09-01 12:09:00', NULL, '0', '<p>【商品名称】悦航优选 有机黄小米 1kg/袋</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 94, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000064', '悦航优选 红芸豆 500g/袋', '豆粒饱满 沙糯香甜', '', '1', 2701, '9510000000000000007', '9520000000000000030', '9530000000000000001', '2026-09-01 12:12:00', NULL, '0', '<p>【商品名称】悦航优选 红芸豆 500g/袋</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 191, '0', NULL, 12.90, 15.90, 8.38),
('9540000000000000065', '金龙鱼 压榨一级花生油 4L/桶', '物理压榨 花生浓香', '', '1', 2838, '9510000000000000007', '9520000000000000031', '9530000000000000011', '2026-09-01 12:15:00', NULL, '0', '<p>【商品名称】金龙鱼 压榨一级花生油 4L/桶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 288, '0', NULL, 109.90, 136.90, 71.44),
('9540000000000000066', '鲁花 5S压榨一级花生油 5L/桶', '5S物理压榨 香飘万家', '', '1', 2975, '9510000000000000007', '9520000000000000031', '9530000000000000013', '2026-09-01 12:18:00', NULL, '0', '<p>【商品名称】鲁花 5S压榨一级花生油 5L/桶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 385, '0', NULL, 159.90, 199.90, 103.94),
('9540000000000000067', '海天 金标生抽 1.9L/瓶', '头道酿造 鲜香回味', '', '1', 3112, '9510000000000000007', '9520000000000000032', '9530000000000000014', '2026-09-01 12:21:00', NULL, '0', '<p>【商品名称】海天 金标生抽 1.9L/瓶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 482, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000068', '太太乐 三鲜鸡精 400g/罐', '提鲜增味 汤菜皆宜', '', '1', 49, '9510000000000000007', '9520000000000000032', '9530000000000000015', '2026-09-01 12:24:00', NULL, '0', '<p>【商品名称】太太乐 三鲜鸡精 400g/罐</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 579, '0', NULL, 12.90, 15.90, 8.38);

-- 休闲零食
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000069', '洽洽 每日坚果 30日装 750g', '科学配比 独立锁鲜', '', '1', 186, '9510000000000000008', '9520000000000000033', '9530000000000000016', '2026-09-01 12:27:00', NULL, '0', '<p>【商品名称】洽洽 每日坚果 30日装 750g</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 676, '0', NULL, 89.90, 111.90, 58.44),
('9540000000000000070', '三只松鼠 碧根果 500g/袋', '壳薄仁大 奶香酥脆', '', '1', 323, '9510000000000000008', '9520000000000000033', '9530000000000000017', '2026-09-01 12:30:00', NULL, '0', '<p>【商品名称】三只松鼠 碧根果 500g/袋</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 773, '0', NULL, 39.90, 49.90, 25.93),
('9540000000000000071', '乐事 原味薯片 104g×3连包', '轻薄酥脆 经典原味', '', '1', 460, '9510000000000000008', '9520000000000000034', '9530000000000000018', '2026-09-01 12:33:00', NULL, '0', '<p>【商品名称】乐事 原味薯片 104g×3连包</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 870, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000072', '好丽友 薯愿原味薯片 104g', '非油炸 轻负担', '', '1', 597, '9510000000000000008', '9520000000000000034', '9530000000000000019', '2026-09-01 12:36:00', NULL, '0', '<p>【商品名称】好丽友 薯愿原味薯片 104g</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 67, '0', NULL, 8.90, 10.90, 5.79),
('9540000000000000073', '奥利奥 原味夹心饼干 388g/盒', '扭一扭 舔一舔 泡一泡', '', '1', 734, '9510000000000000008', '9520000000000000035', '9530000000000000020', '2026-09-01 12:39:00', NULL, '0', '<p>【商品名称】奥利奥 原味夹心饼干 388g/盒</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 164, '0', NULL, 16.90, 20.90, 10.98),
('9540000000000000074', '盼盼 梅尼耶干蛋糕 1kg/箱', '奶香酥脆 早餐搭配', '', '1', 871, '9510000000000000008', '9520000000000000035', '9530000000000000021', '2026-09-01 12:42:00', NULL, '0', '<p>【商品名称】盼盼 梅尼耶干蛋糕 1kg/箱</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 261, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000075', '德芙 丝滑牛奶巧克力 252g/盒', '纵享丝滑 浓醇可可', '', '1', 1008, '9510000000000000008', '9520000000000000036', '9530000000000000022', '2026-09-01 12:45:00', NULL, '0', '<p>【商品名称】德芙 丝滑牛奶巧克力 252g/盒</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 358, '0', NULL, 39.90, 49.90, 25.93),
('9540000000000000076', '徐福记 酥心糖 500g/袋', '花生酥香 甜蜜分享', '', '1', 1145, '9510000000000000008', '9520000000000000036', '9530000000000000023', '2026-09-01 12:48:00', NULL, '0', '<p>【商品名称】徐福记 酥心糖 500g/袋</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 455, '0', NULL, 25.90, 31.90, 16.84),
('9540000000000000077', '百草味 芒果干 300g/袋', '酸甜软糯 果香浓郁', '', '1', 1282, '9510000000000000008', '9520000000000000037', '9530000000000000024', '2026-09-01 12:51:00', NULL, '0', '<p>【商品名称】百草味 芒果干 300g/袋</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 552, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000078', '悦航优选 新疆无核葡萄干 500g/袋', '粒粒饱满 自然晾晒', '', '1', 1419, '9510000000000000008', '9520000000000000037', '9530000000000000001', '2026-09-01 12:54:00', NULL, '0', '<p>【商品名称】悦航优选 新疆无核葡萄干 500g/袋</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 649, '0', NULL, 21.90, 26.90, 14.23);

-- 酒水饮料
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000079', '农夫山泉 饮用天然水 550ml×24瓶', '天然水源 略带甜味', '', '1', 1556, '9510000000000000009', '9520000000000000038', '9530000000000000025', '2026-09-01 12:57:00', NULL, '0', '<p>【商品名称】农夫山泉 饮用天然水 550ml×24瓶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 746, '0', NULL, 39.90, 49.90, 25.93),
('9540000000000000080', '农夫山泉 饮用天然水 4L×4桶', '家庭装 大容量更划算', '', '1', 1693, '9510000000000000009', '9520000000000000038', '9530000000000000025', '2026-09-01 13:00:00', NULL, '0', '<p>【商品名称】农夫山泉 饮用天然水 4L×4桶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 843, '0', NULL, 49.90, 61.90, 32.44),
('9540000000000000081', '可口可乐 500ml×12瓶', '冰爽畅快 经典口味', '', '1', 1830, '9510000000000000009', '9520000000000000039', '9530000000000000026', '2026-09-01 13:03:00', NULL, '0', '<p>【商品名称】可口可乐 500ml×12瓶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 940, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000082', '元气森林 白桃味气泡水 480ml×6瓶', '0糖0脂0卡 好喝不怕胖', '', '1', 1967, '9510000000000000009', '9520000000000000039', '9530000000000000027', '2026-09-01 13:06:00', NULL, '0', '<p>【商品名称】元气森林 白桃味气泡水 480ml×6瓶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 137, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000083', '农夫山泉 NFC橙汁 950ml/瓶', '100%鲜榨 冷灌锁鲜', '', '1', 2104, '9510000000000000009', '9520000000000000040', '9530000000000000025', '2026-09-01 13:09:00', NULL, '0', '<p>【商品名称】农夫山泉 NFC橙汁 950ml/瓶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 234, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000084', '三得利 无糖乌龙茶 500ml×15瓶', '0糖0卡 茶香回甘', '', '1', 2241, '9510000000000000009', '9520000000000000040', '9530000000000000028', '2026-09-01 13:12:00', NULL, '0', '<p>【商品名称】三得利 无糖乌龙茶 500ml×15瓶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 331, '0', NULL, 49.90, 61.90, 32.44),
('9540000000000000085', '青岛啤酒 经典10度 500ml×12听', '麦香浓郁 冰爽畅饮', '', '1', 2378, '9510000000000000009', '9520000000000000041', '9530000000000000029', '2026-09-01 13:15:00', NULL, '0', '<p>【商品名称】青岛啤酒 经典10度 500ml×12听</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 428, '0', NULL, 59.90, 74.90, 38.94),
('9540000000000000086', '百威小麦醇正拉罐 500ml×18听', '醇正麦香 聚会畅饮', '', '1', 2515, '9510000000000000009', '9520000000000000041', '9530000000000000030', '2026-09-01 13:18:00', NULL, '0', '<p>【商品名称】百威小麦醇正拉罐 500ml×18听</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 525, '0', NULL, 99.90, 124.90, 64.94),
('9540000000000000087', '牛栏山 陈酿白酒 42度 500ml', '绵甜净爽 口粮之选', '', '1', 2652, '9510000000000000009', '9520000000000000042', '9530000000000000031', '2026-09-01 13:21:00', NULL, '0', '<p>【商品名称】牛栏山 陈酿白酒 42度 500ml</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 622, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000088', '张裕 解百纳干红葡萄酒 750ml', '果香馥郁 宴请之选', '', '1', 2789, '9510000000000000009', '9520000000000000042', '9530000000000000032', '2026-09-01 13:24:00', NULL, '0', '<p>【商品名称】张裕 解百纳干红葡萄酒 750ml</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 719, '0', NULL, 79.90, 99.90, 51.94);

-- 个护清洁
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000089', '海飞丝 去屑洗发露 750ml', '去屑止痒 清爽控油', '', '1', 2926, '9510000000000000010', '9520000000000000043', '9530000000000000033', '2026-09-01 13:27:00', NULL, '0', '<p>【商品名称】海飞丝 去屑洗发露 750ml</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 816, '0', NULL, 54.90, 68.90, 35.69),
('9540000000000000090', '舒肤佳 沐浴露 720ml', '除菌抑菌 温和洁净', '', '1', 3063, '9510000000000000010', '9520000000000000043', '9530000000000000034', '2026-09-01 13:30:00', NULL, '0', '<p>【商品名称】舒肤佳 沐浴露 720ml</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 913, '0', NULL, 39.90, 49.90, 25.93),
('9540000000000000091', '云南白药 牙膏 210g', '清新口气 保护牙龈', '', '1', 3200, '9510000000000000010', '9520000000000000044', '9530000000000000035', '2026-09-01 13:33:00', NULL, '0', '<p>【商品名称】云南白药 牙膏 210g</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 110, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000092', '高露洁 光感白牙膏 180g', '亮白牙齿 清新薄荷', '', '1', 137, '9510000000000000010', '9520000000000000044', '9530000000000000036', '2026-09-01 13:36:00', NULL, '0', '<p>【商品名称】高露洁 光感白牙膏 180g</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 207, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000093', '维达 棉韧抽纸 3层130抽×24包', '加厚韧性强 整箱更划算', '', '1', 274, '9510000000000000010', '9520000000000000045', '9530000000000000037', '2026-09-01 13:39:00', NULL, '0', '<p>【商品名称】维达 棉韧抽纸 3层130抽×24包</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 304, '0', NULL, 69.90, 86.90, 45.44),
('9540000000000000094', '心相印 厨房湿巾 40抽×3包', '去油污 一擦即净', '', '1', 411, '9510000000000000010', '9520000000000000045', '9530000000000000038', '2026-09-01 13:42:00', NULL, '0', '<p>【商品名称】心相印 厨房湿巾 40抽×3包</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 401, '0', NULL, 19.90, 24.90, 12.93),
('9540000000000000095', '蓝月亮 洗衣液 3kg/瓶', '深层洁净 柔顺留香', '', '1', 548, '9510000000000000010', '9520000000000000046', '9530000000000000039', '2026-09-01 13:45:00', NULL, '0', '<p>【商品名称】蓝月亮 洗衣液 3kg/瓶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 498, '0', NULL, 39.90, 49.90, 25.93),
('9540000000000000096', '立白 洗洁精 1.5kg/瓶', '温和去油 不伤手', '', '1', 685, '9510000000000000010', '9520000000000000046', '9530000000000000040', '2026-09-01 13:48:00', NULL, '0', '<p>【商品名称】立白 洗洁精 1.5kg/瓶</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 595, '0', NULL, 19.90, 24.90, 12.93);

-- 日用百货
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000097', '美丽雅 点断式保鲜袋 200只/卷', '加厚耐用 密封防潮', '', '1', 822, '9510000000000000011', '9520000000000000047', '9530000000000000041', '2026-09-01 13:51:00', NULL, '0', '<p>【商品名称】美丽雅 点断式保鲜袋 200只/卷</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 692, '0', NULL, 12.90, 15.90, 8.38),
('9540000000000000098', '悦航优选 硅胶铲勺三件套', '耐高温不伤锅 易清洗', '', '1', 959, '9510000000000000011', '9520000000000000047', '9530000000000000001', '2026-09-01 13:54:00', NULL, '0', '<p>【商品名称】悦航优选 硅胶铲勺三件套</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 789, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000099', '悦航优选 棉麻收纳袋 三件套', '透气棉麻 整齐收纳', '', '1', 1096, '9510000000000000011', '9520000000000000048', '9530000000000000001', '2026-09-01 13:57:00', NULL, '0', '<p>【商品名称】悦航优选 棉麻收纳袋 三件套</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 886, '0', NULL, 24.90, 30.90, 16.18),
('9540000000000000100', '悦航优选 折叠收纳箱 30L', '承重加固 可折叠省空间', '', '1', 1233, '9510000000000000011', '9520000000000000048', '9530000000000000001', '2026-09-01 14:00:00', NULL, '0', '<p>【商品名称】悦航优选 折叠收纳箱 30L</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 83, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000101', '妙洁 一次性纸杯 250ml×50只', '加厚挺括 不渗不漏', '', '1', 1370, '9510000000000000011', '9520000000000000049', '9530000000000000042', '2026-09-01 14:03:00', NULL, '0', '<p>【商品名称】妙洁 一次性纸杯 250ml×50只</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 180, '0', NULL, 12.90, 15.90, 8.38),
('9540000000000000102', '悦航优选 一次性加厚台布 10片', '防水防油 野餐聚会', '', '1', 1507, '9510000000000000011', '9520000000000000049', '9530000000000000001', '2026-09-01 14:06:00', NULL, '0', '<p>【商品名称】悦航优选 一次性加厚台布 10片</p><p>【储存方式】常温密封保存，避免阳光直射与高温潮湿。</p><p>【温馨提示】请在保质期内食用完毕，如发现包装破损或漏气，请勿食用并可联系售后。</p>', '0', '1590229800633634816', 'system', NULL, 277, '0', NULL, 9.90, 11.90, 6.44);

-- 鲜花绿植
INSERT INTO `goods_spu` (`id`, `name`, `sub_title`, `spu_urls`, `status`, `sales_volume`, `category_first_id`, `category_second_id`, `brand_id`, `create_time`, `update_time`, `del_flag`, `description`, `enable_specs`, `tenant_id`, `create_by`, `update_by`, `stock`, `freight_type`, `fixed_freight_price`, `sales_price`, `original_price`, `cost_price`) VALUES
('9540000000000000103', '云南直发 玫瑰混搭花束 10枝', '基地直采 冷链保鲜', '', '1', 1644, '9510000000000000012', '9520000000000000050', NULL, '2026-09-01 14:09:00', NULL, '0', '<p>【商品名称】云南直发 玫瑰混搭花束 10枝</p><p>【养护说明】收到后请立即剪根并深水养护，避免阳光直射与风口直吹。</p><p>【温馨提示】鲜花绿植为自然生长，形态花期存在个体差异，以实际收到商品为准。</p>', '0', '1590229800633634816', 'system', NULL, 374, '0', NULL, 29.90, 36.90, 19.43),
('9540000000000000104', '云南直发 向日葵鲜切花 5枝', '阳光治愈 花期持久', '', '1', 1781, '9510000000000000012', '9520000000000000050', NULL, '2026-09-01 14:12:00', NULL, '0', '<p>【商品名称】云南直发 向日葵鲜切花 5枝</p><p>【养护说明】收到后请立即剪根并深水养护，避免阳光直射与风口直吹。</p><p>【温馨提示】鲜花绿植为自然生长，形态花期存在个体差异，以实际收到商品为准。</p>', '0', '1590229800633634816', 'system', NULL, 471, '0', NULL, 25.90, 31.90, 16.84),
('9540000000000000105', '绿萝盆栽 带盆栽好 苗高约15cm', '好养易活 净化空气', '', '1', 1918, '9510000000000000012', '9520000000000000051', NULL, '2026-09-01 14:15:00', NULL, '0', '<p>【商品名称】绿萝盆栽 带盆栽好 苗高约15cm</p><p>【养护说明】收到后请立即剪根并深水养护，避免阳光直射与风口直吹。</p><p>【温馨提示】鲜花绿植为自然生长，形态花期存在个体差异，以实际收到商品为准。</p>', '0', '1590229800633634816', 'system', NULL, 568, '0', NULL, 15.90, 19.90, 10.34),
('9540000000000000106', '多肉植物组合盆栽 3棵装', '呆萌治愈 随机发货', '', '1', 2055, '9510000000000000012', '9520000000000000051', NULL, '2026-09-01 14:18:00', NULL, '0', '<p>【商品名称】多肉植物组合盆栽 3棵装</p><p>【养护说明】收到后请立即剪根并深水养护，避免阳光直射与风口直吹。</p><p>【温馨提示】鲜花绿植为自然生长，形态花期存在个体差异，以实际收到商品为准。</p>', '0', '1590229800633634816', 'system', NULL, 665, '0', NULL, 19.90, 24.90, 12.93);

INSERT INTO `goods_sku` (`id`, `spu_id`, `sales_price`, `original_price`, `cost_price`, `stock`, `weight`, `volume`, `create_time`, `update_time`, `del_flag`, `version`, `tenant_id`, `create_by`, `update_by`, `specs_json`, `status`, `specs_arr`, `pic_url`) VALUES
('9550000000000000001', '9540000000000000001', 3.90, 4.90, 2.54, 380, 0.30, NULL, '2026-09-01 09:03:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000002', '9540000000000000002', 4.90, 5.90, 3.19, 477, 0.30, NULL, '2026-09-01 09:06:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000003', '9540000000000000003', 6.90, 8.90, 4.49, 574, 0.50, NULL, '2026-09-01 09:09:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000004', '9540000000000000004', 3.90, 4.90, 2.54, 671, 0.50, NULL, '2026-09-01 09:12:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000005', '9540000000000000005', 4.50, 5.90, 2.93, 768, 0.50, NULL, '2026-09-01 09:15:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000006', '9540000000000000006', 3.60, 3.90, 2.34, 865, 0.40, NULL, '2026-09-01 09:18:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000007', '9540000000000000007', 7.90, 9.90, 5.14, 62, 0.50, NULL, '2026-09-01 09:21:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000008', '9540000000000000008', 5.90, 6.90, 3.84, 159, 0.30, NULL, '2026-09-01 09:24:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000009', '9540000000000000009', 4.50, 5.90, 2.93, 256, 0.40, NULL, '2026-09-01 09:27:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000010', '9540000000000000010', 2.90, 3.90, 1.89, 353, 0.10, NULL, '2026-09-01 09:30:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000011', '9540000000000000011', 6.90, 8.90, 4.49, 450, 0.20, NULL, '2026-09-01 09:33:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000012', '9540000000000000012', 8.90, 10.90, 5.79, 547, 0.40, NULL, '2026-09-01 09:36:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000013', '9540000000000000013', 9.90, 11.90, 6.44, 644, 0.30, NULL, '2026-09-01 09:39:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000014', '9540000000000000014', 6.50, 7.90, 4.23, 741, 0.80, NULL, '2026-09-01 09:42:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000015', '9540000000000000015', 5.90, 6.90, 3.84, 838, 0.30, NULL, '2026-09-01 09:45:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000016', '9540000000000000016', 15.90, 19.90, 10.34, 935, 1.00, NULL, '2026-09-01 09:48:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000017', '9540000000000000017', 19.90, 24.90, 12.93, 132, 1.20, NULL, '2026-09-01 09:51:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000018', '9540000000000000018', 16.90, 20.90, 10.98, 229, 1.00, NULL, '2026-09-01 09:54:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000019', '9540000000000000019', 12.90, 15.90, 8.38, 326, 1.00, NULL, '2026-09-01 09:57:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000020', '9540000000000000020', 9.90, 11.90, 6.44, 423, 1.00, NULL, '2026-09-01 10:00:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000021', '9540000000000000021', 13.90, 16.90, 9.04, 520, 0.50, NULL, '2026-09-01 10:03:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000022', '9540000000000000022', 19.90, 24.90, 12.93, 617, 1.00, NULL, '2026-09-01 10:06:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000023', '9540000000000000023', 29.90, 36.90, 19.43, 714, 2.00, NULL, '2026-09-01 10:09:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000024', '9540000000000000024', 19.90, 24.90, 12.93, 811, 1.50, NULL, '2026-09-01 10:12:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000025', '9540000000000000025', 25.90, 31.90, 16.84, 908, 0.50, NULL, '2026-09-01 10:15:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000026', '9540000000000000026', 29.90, 36.90, 19.43, 105, 0.25, NULL, '2026-09-01 10:18:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000027', '9540000000000000027', 15.90, 19.90, 10.34, 202, 0.30, NULL, '2026-09-01 10:21:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000028', '9540000000000000028', 17.90, 21.90, 11.63, 299, 0.30, NULL, '2026-09-01 10:24:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000029', '9540000000000000029', 39.90, 49.90, 25.93, 396, 0.50, NULL, '2026-09-01 10:27:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000030', '9540000000000000030', 59.90, 74.90, 38.94, 493, 0.30, NULL, '2026-09-01 10:30:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000031', '9540000000000000031', 29.90, 36.90, 19.43, 590, 0.30, NULL, '2026-09-01 10:33:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000032', '9540000000000000032', 49.90, 61.90, 32.44, 687, 0.60, NULL, '2026-09-01 10:36:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000033', '9540000000000000033', 29.90, 36.90, 19.43, 784, 1.00, NULL, '2026-09-01 10:39:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000034', '9540000000000000034', 12.90, 15.90, 8.38, 881, 0.50, NULL, '2026-09-01 10:42:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000035', '9540000000000000035', 12.90, 15.90, 8.38, 78, 0.50, NULL, '2026-09-01 10:45:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000036', '9540000000000000036', 13.90, 16.90, 9.04, 175, 0.36, NULL, '2026-09-01 10:48:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000037', '9540000000000000037', 39.90, 49.90, 25.93, 272, 0.25, NULL, '2026-09-01 10:51:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000038', '9540000000000000038', 49.90, 61.90, 32.44, 369, 0.40, NULL, '2026-09-01 10:54:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000039', '9540000000000000039', 49.90, 61.90, 32.44, 466, 0.20, NULL, '2026-09-01 10:57:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000040', '9540000000000000040', 35.90, 44.90, 23.34, 563, 0.50, NULL, '2026-09-01 11:00:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000041', '9540000000000000041', 24.90, 30.90, 16.18, 660, 0.25, NULL, '2026-09-01 11:03:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000042', '9540000000000000042', 12.90, 15.90, 8.38, 757, 0.50, NULL, '2026-09-01 11:06:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000043', '9540000000000000043', 79.90, 99.90, 51.94, 854, 2.00, NULL, '2026-09-01 11:09:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000044', '9540000000000000044', 19.90, 24.90, 12.93, 51, 0.30, NULL, '2026-09-01 11:12:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000045', '9540000000000000045', 12.90, 15.90, 8.38, 148, 0.96, NULL, '2026-09-01 11:15:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000046', '9540000000000000046', 13.90, 16.90, 9.04, 245, 0.96, NULL, '2026-09-01 11:18:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000047', '9540000000000000047', 19.90, 24.90, 12.93, 342, 0.41, NULL, '2026-09-01 11:21:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000048', '9540000000000000048', 13.90, 16.90, 9.04, 439, 0.75, NULL, '2026-09-01 11:24:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000049', '9540000000000000049', 65.90, 81.90, 42.84, 536, 2.60, NULL, '2026-09-01 11:27:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000050', '9540000000000000050', 69.90, 86.90, 45.44, 633, 2.60, NULL, '2026-09-01 11:30:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000051', '9540000000000000051', 15.90, 19.90, 10.34, 730, 0.32, NULL, '2026-09-01 11:33:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000052', '9540000000000000052', 19.90, 24.90, 12.93, 827, 0.36, NULL, '2026-09-01 11:36:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000053', '9540000000000000053', 19.90, 24.90, 12.93, 924, 0.35, NULL, '2026-09-01 11:39:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000054', '9540000000000000054', 21.90, 26.90, 14.23, 121, 0.35, NULL, '2026-09-01 11:42:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000055', '9540000000000000055', 25.90, 31.90, 16.84, 218, 0.32, NULL, '2026-09-01 11:45:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000056', '9540000000000000056', 32.90, 40.90, 21.39, 315, 0.40, NULL, '2026-09-01 11:48:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000057', '9540000000000000057', 35.90, 44.90, 23.34, 412, 0.20, NULL, '2026-09-01 11:51:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000058', '9540000000000000058', 36.90, 45.90, 23.98, 509, 0.60, NULL, '2026-09-01 11:54:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000059', '9540000000000000059', 26.90, 33.90, 17.48, 606, 0.40, NULL, '2026-09-01 11:57:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000060', '9540000000000000060', 9.90, 11.90, 6.44, 703, 0.48, NULL, '2026-09-01 12:00:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000061', '9540000000000000061', 49.90, 61.90, 32.44, 800, 5.00, NULL, '2026-09-01 12:03:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000062', '9540000000000000062', 25.90, 31.90, 16.84, 897, 2.50, NULL, '2026-09-01 12:06:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000063', '9540000000000000063', 19.90, 24.90, 12.93, 94, 1.00, NULL, '2026-09-01 12:09:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000064', '9540000000000000064', 12.90, 15.90, 8.38, 191, 0.50, NULL, '2026-09-01 12:12:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000065', '9540000000000000065', 109.90, 136.90, 71.44, 288, 4.30, NULL, '2026-09-01 12:15:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000066', '9540000000000000066', 159.90, 199.90, 103.94, 385, 5.30, NULL, '2026-09-01 12:18:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000067', '9540000000000000067', 19.90, 24.90, 12.93, 482, 2.10, NULL, '2026-09-01 12:21:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000068', '9540000000000000068', 12.90, 15.90, 8.38, 579, 0.40, NULL, '2026-09-01 12:24:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000069', '9540000000000000069', 89.90, 111.90, 58.44, 676, 0.75, NULL, '2026-09-01 12:27:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000070', '9540000000000000070', 39.90, 49.90, 25.93, 773, 0.50, NULL, '2026-09-01 12:30:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000071', '9540000000000000071', 19.90, 24.90, 12.93, 870, 0.31, NULL, '2026-09-01 12:33:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000072', '9540000000000000072', 8.90, 10.90, 5.79, 67, 0.10, NULL, '2026-09-01 12:36:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000073', '9540000000000000073', 16.90, 20.90, 10.98, 164, 0.39, NULL, '2026-09-01 12:39:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000074', '9540000000000000074', 29.90, 36.90, 19.43, 261, 1.00, NULL, '2026-09-01 12:42:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000075', '9540000000000000075', 39.90, 49.90, 25.93, 358, 0.25, NULL, '2026-09-01 12:45:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000076', '9540000000000000076', 25.90, 31.90, 16.84, 455, 0.50, NULL, '2026-09-01 12:48:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000077', '9540000000000000077', 19.90, 24.90, 12.93, 552, 0.30, NULL, '2026-09-01 12:51:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000078', '9540000000000000078', 21.90, 26.90, 14.23, 649, 0.50, NULL, '2026-09-01 12:54:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000079', '9540000000000000079', 39.90, 49.90, 25.93, 746, 13.50, NULL, '2026-09-01 12:57:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000080', '9540000000000000080', 49.90, 61.90, 32.44, 843, 16.50, NULL, '2026-09-01 13:00:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000081', '9540000000000000081', 29.90, 36.90, 19.43, 940, 6.20, NULL, '2026-09-01 13:03:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000082', '9540000000000000082', 29.90, 36.90, 19.43, 137, 3.10, NULL, '2026-09-01 13:06:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000083', '9540000000000000083', 19.90, 24.90, 12.93, 234, 1.00, NULL, '2026-09-01 13:09:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000084', '9540000000000000084', 49.90, 61.90, 32.44, 331, 7.70, NULL, '2026-09-01 13:12:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000085', '9540000000000000085', 59.90, 74.90, 38.94, 428, 6.30, NULL, '2026-09-01 13:15:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000086', '9540000000000000086', 99.90, 124.90, 64.94, 525, 9.30, NULL, '2026-09-01 13:18:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000087', '9540000000000000087', 19.90, 24.90, 12.93, 622, 0.55, NULL, '2026-09-01 13:21:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000088', '9540000000000000088', 79.90, 99.90, 51.94, 719, 1.30, NULL, '2026-09-01 13:24:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000089', '9540000000000000089', 54.90, 68.90, 35.69, 816, 0.80, NULL, '2026-09-01 13:27:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000090', '9540000000000000090', 39.90, 49.90, 25.93, 913, 0.78, NULL, '2026-09-01 13:30:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000091', '9540000000000000091', 29.90, 36.90, 19.43, 110, 0.24, NULL, '2026-09-01 13:33:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000092', '9540000000000000092', 19.90, 24.90, 12.93, 207, 0.21, NULL, '2026-09-01 13:36:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000093', '9540000000000000093', 69.90, 86.90, 45.44, 304, 6.00, NULL, '2026-09-01 13:39:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000094', '9540000000000000094', 19.90, 24.90, 12.93, 401, 0.45, NULL, '2026-09-01 13:42:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000095', '9540000000000000095', 39.90, 49.90, 25.93, 498, 3.10, NULL, '2026-09-01 13:45:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000096', '9540000000000000096', 19.90, 24.90, 12.93, 595, 1.60, NULL, '2026-09-01 13:48:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000097', '9540000000000000097', 12.90, 15.90, 8.38, 692, 0.20, NULL, '2026-09-01 13:51:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000098', '9540000000000000098', 29.90, 36.90, 19.43, 789, 0.50, NULL, '2026-09-01 13:54:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000099', '9540000000000000099', 24.90, 30.90, 16.18, 886, 0.30, NULL, '2026-09-01 13:57:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000100', '9540000000000000100', 29.90, 36.90, 19.43, 83, 1.20, NULL, '2026-09-01 14:00:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000101', '9540000000000000101', 12.90, 15.90, 8.38, 180, 0.40, NULL, '2026-09-01 14:03:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000102', '9540000000000000102', 9.90, 11.90, 6.44, 277, 0.30, NULL, '2026-09-01 14:06:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000103', '9540000000000000103', 29.90, 36.90, 19.43, 374, 0.50, NULL, '2026-09-01 14:09:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000104', '9540000000000000104', 25.90, 31.90, 16.84, 471, 0.50, NULL, '2026-09-01 14:12:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000105', '9540000000000000105', 15.90, 19.90, 10.34, 568, 0.40, NULL, '2026-09-01 14:15:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL),
('9550000000000000106', '9540000000000000106', 19.90, 24.90, 12.93, 665, 0.30, NULL, '2026-09-01 14:18:00', NULL, '0', 0, '1590229800633634816', 'system', NULL, NULL, '0', NULL, NULL);

SET FOREIGN_KEY_CHECKS = 1;

-- ============================================================================
-- 会员管理模块
-- Source: db/boot/4aryn_boot_member.sql
-- ============================================================================
-- =====================================================
-- 会员管理模块 - Boot模式增量SQL
...
-- ============================================================================
-- 站内信与客服会话
-- Source: db/boot/20message_center.sql
-- ============================================================================
-- 站内信与客服会话
USE `aryn_boot`;
...
-- ============================================================================
-- 消息中心菜单与权限
-- Source: db/boot/20message_menu.sql
-- ============================================================================
USE aryn_boot;
...
-- ============================================================================
-- 页面装修类型升级
-- Source: db/boot/10page_design_alter.sql
-- ============================================================================
USE aryn_boot;
...
-- ============================================================================
-- 页面装修发布与模板
-- Source: db/boot/11page_design_publish.sql
-- ============================================================================
USE aryn_boot;
...
-- ============================================================================
-- 员工账号与配送员管理重构
-- Source: db/boot/37employee_role_scope.sql
-- ============================================================================
-- 员工账号与配送员管理重构增量迁移（Boot 单体模式）
-- 目标库：aryn_boot
-- 背景：
...
-- 执行：mysql -u root -p aryn_boot < 37employee_role_scope.sql
...
-- 2) 预检查 2：拥有配送员角色但没有配送员资料的员工账号（历史半成品数据，应返回空结果集；
--    如有返回，请在配送员管理中补建配送资料，或确认后回收配送资格）
...
-- 3) 预检查 3：迁移台账（受影响租户与角色统计，供上线记录留存）
...
-- 4) 幂等补齐每个租户的最低权限员工角色“普通员工”（ROLE_STAFF）：
--    覆盖 sys_tenant 登记租户与 sys_user 中实际存在的租户，已存在（含逻辑删除后恢复）不重复插入
...
-- 7) 仅在当前不存在重复角色编码时补齐唯一约束；存在重复（预检查 1 有结果）时跳过并提示，
--    待人工迁移完成后重跑本脚本
SET @dup_count = (
  SELECT COUNT(*) FROM (
...
-- ============================================================================
-- 字典与菜单乱码数据修复
-- Source: db/boot/38dict_charset_mojibake_repair.sql
-- ============================================================================
-- 字典与菜单乱码数据修复（Boot 单体模式）
-- 目标库：aryn_boot
...
--       正常中文与英文数据不受影响。
-- 执行：mysql -u root -p --default-character-set=utf8mb4 aryn_boot < 38dict_charset_mojibake_repair.sql
-- 验证：SELECT dict_label FROM sys_dict_value WHERE dict_type='sys_storage_type';
...
-- ============================================================================
-- 配送模块按钮权限补齐
-- Source: db/boot/39delivery_menu_button_patch.sql
-- ============================================================================
-- ============================================================================
-- 配送模块按钮权限补齐
...
-- ============================================================================
-- 配送员受保护角色修复与遗留角色下线
-- Source: db/boot/40delivery_staff_role_repair.sql
-- ============================================================================
...
-- ============================================================================
-- 船舶与靠港计划域
-- Source: db/boot/42vessel_context_incremental.sql
-- ============================================================================
...
-- ============================================================================
-- 悦航购订单配送上下文与履约域增量迁移（Boot 单体模式）
-- 目标库：aryn_boot
-- 特性：可重复执行，不执行 DROP/TRUNCATE，不覆盖已有业务数据。
-- 执行：mysql -u root -p aryn_boot < 44order_delivery_context_incremental.sql
...
-- ============================================================================
-- 八、配送方式字典值（delivery_way=4 公司港口/船舶内部配送）
-- ============================================================================
INSERT IGNORE INTO `sys_dict_value`
(`id`,`dict_id`,`dict_label`,`dict_value`,`dict_type`,`status`,`remarks`,`sort`,`del_flag`,`create_time`,`create_by`)
...
-- ============================================================================
-- 商品批量导入与变更审计域
-- Source: db/boot/48product_import_incremental.sql
-- ============================================================================
-- 悦航购商品批量导入与变更审计域增量迁移（Boot 单体模式）
-- 目标库：aryn_boot
-- 特性：可重复执行，不执行 DROP/TRUNCATE，不覆盖已有业务数据。
-- 执行：mysql -u root -p aryn_boot < 48product_import_incremental.sql
...
-- ============================================================================
-- 船供菜单权限与租户能力
-- Source: db/boot/45ship_supply_menu_permission.sql
-- ============================================================================
-- 悦航购船供化菜单权限与租户能力增量（Boot 单体模式）
-- 目标库：aryn_boot
...
-- ============================================================================
-- 船供试点种子数据
-- Source: db/boot/46ship_supply_seed_pilot.sql
-- ============================================================================
...
-- ============================================================================
-- 船供营销二期（活动/锁定/分摊列）
-- Source: db/boot/53promotion_ship_supply_incremental.sql
-- ============================================================================
-- 悦航购船供营销二期增量迁移（Boot 单体模式）
-- 目标库：aryn_boot
-- 特性：可重复执行，不执行 DROP/TRUNCATE，不覆盖已有业务数据。
...
-- ============================================================================
-- 船供营销二期菜单
-- Source: db/boot/55promotion_ship_menu.sql
-- ============================================================================
...
-- ============================================================================
-- 靠港计划变更日志
-- Source: db/boot/56vessel_call_change_log.sql
-- ============================================================================
...
-- ============================================================================
-- 共享购物车管理页菜单
-- Source: db/boot/57shared_cart_admin_menu.sql
-- ============================================================================
...
-- ============================================================================
-- 购物车船舶归属
-- Source: db/boot/58shopping_cart_vessel_incremental.sql
-- ============================================================================
-- 悦航购购物车船舶归属增量迁移（Boot 单体模式）
-- 目标库：aryn_boot
...
-- ============================================================================
-- 买赠赠品标记
-- Source: db/boot/59gift_activity_incremental.sql
-- ============================================================================
-- 悦航购买赠活动增量迁移（Boot 单体模式）
-- 目标库：aryn_boot
...
-- ============================================================================
-- XXL-JOB 调度库
-- Source: db/boot/3aryn_boot_job.sql
-- ============================================================================
USE aryn_boot_job;
...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (1, 'aryn-boot', '单体执行器', 0, 'http://192.168.31.89:9009/', '2025-05-24 21:47:41');
...
-- ----------------------------
INSERT INTO `xxl_job_registry` VALUES (2, 'EXECUTOR', 'aryn-boot', 'http://192.168.31.89:9009/', '2025-05-24 21:47:54');
